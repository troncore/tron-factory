export default {
  ...
  description: 'One Click Deployment(OCD) is an enterprise-class BaaS(Blockchian as a Service) deployment tookit.',
  ...
  getStartDeploy: 'Get Started',
  viewDocument: 'Help Document',
  forNewUserTitle: 'For New User Necessary',
  addNode: 'Adding Node',
  addNodeTips: 'Add node information',
  configManage: 'Configuration management',
  configManageTips: 'Configuration misc information about chain',
  pluginImport: 'Plugin configuration',
  pluginImportTips: 'Enable or disable plugins',
  nodeDeploy: 'Node deployment',
  nodeDeployTips: 'Deploy nodes',
}
