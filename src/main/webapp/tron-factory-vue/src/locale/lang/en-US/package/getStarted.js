export default {
  ...
  dashboard: {
    ...
    exportFileName: 'TRON-Factory Node List',
    importList: 'Import list',
    importHelp: 'Import Tip',
    ...
    unvalidFileForJSON: 'The file content format does not conform to the JSON specification',
    emptyFile: 'File content is empty',
    SSHConnectFail: 'SSH authentication failed',
    emptyIP: 'Node IP cannot be empty',
    existIP: 'Node IP already exists',
    repeatIP: 'Node IP cannot be duplicated',
    unValidIP: 'Node IP format is not compliant',
    emptySSHUsername: 'The node username cannot be empty.',
    emptyUsername: 'File content is empty',
    selectImportNodes: 'Please check the nodes that meet the specifications to import',
