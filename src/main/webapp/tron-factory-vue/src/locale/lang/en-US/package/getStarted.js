export default {
  ...
  summaryChain: 'TRON Factory, customized blockchain based on TRON Framework',
  descriptionChain: 'Quickly deploy customized blockchain based on TRON Framework, aim to provide professional blockchain-related services to enterprise users.',

  // 创建/修改区块链
  chainManage: {
    startCreate: 'Get Started',
    updateChain: 'Edit',
    baseInfo: 'Basics Configuration',
  ...
  dashboard: {
    ...
    published: 'Released',
    statusTips: 'Only "Released" blockchain produces blocks',
    explorer: 'Explorer',
