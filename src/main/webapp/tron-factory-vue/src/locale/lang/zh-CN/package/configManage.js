export default {
  ...
  isWriteSync: '是否同步写入',
  isOpenTransaction: '是否打开transaction',
  selectDatabaseConfig: '选择数据库配置',
  isOpenIndexDirectory: '是否打开index开关',
  isNeedToUpdateAsset: '是否需要更新assets',
  ...
  helpTips: {
    ...
    maxHttpConnectNumber: '最大http连接数',
    httpFullNodePort: 'httpFullNode端口',
    httpSolidityPort: 'httpSolidity端口',
    rpcPort: 'rpc端口',
    rpcSolidityPort: 'rpcSolidity端口',
