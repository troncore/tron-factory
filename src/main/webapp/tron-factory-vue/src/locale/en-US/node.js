export default {
  ...
  tronNodesDeleteTips:
    'This action will delete the node information, will it continue?',
  ...
  deploymentUpload:
    'First, you need to fill in the local jar package file path before batch deployment. ex:/Users/xxx/xxx/java-tron-1.0.0.zip',
  ...
  deploymentLoading:
    'Deploying, please wait,Click on the list to view details to view deployment status',
  ...
  deploymentNodePrivateKeyTips:
    'Please enter a 64-bit private key (saved locally, will not upload the server)',
  ...
  deploymentNodeSyncCheckTips:
    'Do you need synchronous detection，Only one SR in the new chain is false, others are true',
