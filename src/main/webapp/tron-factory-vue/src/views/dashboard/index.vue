  ...
  <div class="dashboard-container">
    <el-row>
      <div class="tronContent">
        ...
        <p class="action">
          <el-button type="warning" @click="handleStartSettingDeploy">{{ $t('startTronOneClickDeploy') }}</el-button>
        </p>
      </div>
    </el-row>
    <el-row>
      ...
      <div class="help">
        <el-button type="text" size="small" @click="handleViewDocument">{{ $t('tronDashboardHelpTips') }}</el-button>
      </div>
    </el-row>
  </div>
</template>
