      ...
      >
        <div class="onsensus">
          ...
          <el-radio-group v-model="pluginForm.onsensus">
            ...
            <br />
            <el-radio style="margin:15px 0" :label="3"
        ...
        <el-form class="transaction" prop="transaction">
          <el-button class="newtransaction">{{
          ...
          <el-checkbox-group v-model="pluginForm.transaction">
            ...
            ></el-checkbox>
            <br />
            <el-checkbox style="margin:15px 0" :label="9">{{
        ...
        <div class="dbModal">
          ...
          <el-radio-group v-model="pluginForm.dbsetting">
            ...
            <br />
            <el-radio style="margin:15px 0" :label="3">{{
              $t('tronPluginCustomDatabaseModule')
            }}</el-radio>
          </el-radio-group>
          <el-input
            :maxlength="50"
      ...
      this.$refs[formName].validate(async valid => {
        if (valid) {
          ...
          if (this.pluginForm.transactionContent != '') {
            ...
            this.pluginForm.transaction.push(this.pluginForm.transactionContent)
          }
          if (this.pluginForm.dbsetting == 3) {
            this.pluginForm.dbsetting = this.pluginForm.dbsettingContent
          }
          console.log(this.pluginForm)
          await this.$_api.pluginApi
            .consensusApi({ onsensus: this.pluginForm.onsensus })
            .then(() => {})
            .catch(error => {
              console.log(error)
            })
          await this.$_api.pluginApi
            .transactionApi(this.pluginForm.transaction)
            .then(() => {})
            .catch(error => {
              console.log(error)
            })
